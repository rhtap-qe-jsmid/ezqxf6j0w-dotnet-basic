...
export IMAGE_URL=${IMAGE_URL-quay.io/jsmid/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/ezqxf6j0w-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-sjt6n.sjt6n.sandbox383.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-sjt6n.sjt6n.sandbox383.opentlc.com}
